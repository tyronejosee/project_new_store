...
urlpatterns = [
    # Cart URLs
    path('', cart, name='cart'),
    path('cart/add/<int:product_id>/', add_prod_cart, name='add_prod_cart'),
    path('cart/remove/<int:product_id>/', remove_prod_cart, name='remove_prod_cart'),
    path('cart/subtract/<int:product_id>/', subtract_prod_cart, name='subtract_prod_cart'),
