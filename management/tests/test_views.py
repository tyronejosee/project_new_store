...
class ManagementViewsTest(BaseTestCase):
    ...
    def test_product_update_view(self):
        ...
        url = reverse('management:product_update', kwargs={'pk': self.product.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'management/product_form.html')
    ...
    def test_product_delete_view(self):
        ...
        url = reverse('management:product_delete', kwargs={'pk': self.product.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)    
    ...
    def test_category_update_view(self):
        ...
        url = reverse('management:category_update', kwargs={'pk': self.category.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'management/category_form.html')
    ...
    def test_category_delete_view(self):
        ...
        url = reverse('management:category_delete', kwargs={'pk': self.category.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
