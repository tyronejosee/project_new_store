...
class UserViewsTest(TestCase):
    ...
    def test_access_without_authentication(self):
        """Test verify that an unauthenticated user can access the login view."""
    ...
    def test_access_with_authentication(self):
        """Test checks redirection for authenticated user accessing login view."""
    ...
    def test_failed_login(self):
        """Test verify login with invalid credentials and verify the error message."""
        data = {
            'username': 'example_user',
    ...
    def test_access_without_authentication_registration(self):
        """Test verify that an unauthenticated user can access the registration view."""
    ...
    def test_successful_registration(self):
        """Test verify the registration form with valid data and verify the redirection."""
        data = {
            'username': 'newuser',
    ...
    def test_authentication_after_registration(self):
        """Test verify that the user is authenticated after successful registration."""
        data = {
            'username': 'newuser',
            'email': 'newuser@example.com',
            'password1': 'testpass123',
    ...
    def test_redirect_authenticated_user_registration(self):
        """Test checks redirection when accessing the registration view while authenticated."""
        self.client.login(username='example_user', password='examplepassword')
        url = reverse('users:registration')
        response = self.client.get(url)
        self.assertRedirects(response, reverse('cart:cart'))
